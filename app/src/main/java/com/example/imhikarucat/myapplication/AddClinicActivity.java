...
public class AddClinicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
        Users cannot change this input as their address was generated by their selected lat long.
        It does not makes any sense as they selected the lat long on the map view and changed the address later.
        If users wished to do so, back out and change where they selected on map view.
        */
    }
    ...
    public void onConfirmAddClinic(View view) {
        if (editName.getText().toString().equals("") || editRating.getText().toString().equals("") || editImpression.getText().toString().equals("")
            ...
            Toast.makeText(AddClinicActivity.this, "Invalid rating input", Toast.LENGTH_SHORT).show();
        } else {
